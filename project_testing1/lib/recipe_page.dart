...
class RecipePage extends StatelessWidget {
  ...
  TextEditingController intructionsController = TextEditingController();
    ...
    bool allParamsEntered(String name, int prep, cook, List<String> ing, String ins)
    {
    ...
    void errorMessage(BuildContext context, Object exceptionThrown) {
      showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            title: Text(exceptionThrown.toString()),
            actions: [
              TextButton(
                onPressed: () {
        ...
        return AlertDialog(
          ...
          content: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            TextField(
              ...
              decoration: const InputDecoration(hintText: "Preptime in minutes"),
            ),
            TextField(
              controller: cooktimeController,
              decoration: const InputDecoration(hintText: "Cooktime in minutes"),
            ),
            TextField(
              controller: ingredientsController,
              decoration: const InputDecoration(hintText: "Ingredients seperated by commas"),
            ),
            TextField(
            ...
            TextButton(
              onPressed: () {
                ...
                try {
                  ...
                  List<String> newIngredients = ingredientsController.text.split(',');
                  String newIntructions = intructionsController.text;
                
                  // Add to recipe list
                  if (allParamsEntered(newName, newPrepTime, newCookTime, newIngredients, newIntructions)) {
                    //Need to put recipe into box
                    final box = Hive.box<Recipe>(recipeStorageName);
                    box.add(Recipe(newName, newPrepTime, newCookTime, newIngredients, newIntructions));
